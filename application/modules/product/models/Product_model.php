...
class Product_model extends CI_Model {
    ...
    var $table = 'products';
    var $column_order = array('p.productId','p.name','p.image','p.code','u.price'); //set column field database for datatable orderable
    var $column_sel = array('p.productId','p.image','p.name','p.code','p.price'); //set column field database for datatable orderable
    var $column_search = array('p.name','p.code','p.price'); //set column field database for datatable searchable 
    var $order = array('p.productId' => 'ASC');  // default order
    var $where = array();
    var $group_by = 'p.productId'; 
