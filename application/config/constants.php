...
define('COPYRIGHT', date('Y').' &copy; Copyright Tele-shop');
...
/* Admin Asset path*/
define('CRM_ADMIN_ASSETS', 'backend_asset/');
define('CRM_ASSETS_CUSTOM_JS', 'backend_asset/custom/js/');
define('CRM_ADMIN_ASSETS_CUSTOM_CSS', 'backend_asset/custom/css/');
define('CRM_ADMIN_ASSETS_IMG', 'backend_asset/img/');
define('CRM_ADMIN_ASSETS_CSS', 'backend_asset/css/');
define('CRM_ADMIN_ASSETS_JS', 'backend_asset/js/');
...
/*Google pLace Api*/
define('GOOGLE_PLACE_API', 'AIzaSyDuEJjb_-knzxl69RX-8hm4_EuCGaNZ7Ao');